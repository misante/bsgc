...
//   try {
//     console.log("📋 Fetching all manpower data");
...
//     console.log(`✅ Found ${data.length} manpower records`);
...
//     console.log("body for supabase table:", body);
//     const dataToInsert = body.manpowerData;
//     const { data, error } = await supabase
//       .from("manpower")
//       .insert([dataToInsert])
//       .select();
