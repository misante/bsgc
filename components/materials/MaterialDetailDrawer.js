...
import MaterialTransactionHistory from "./MaterialTransactionHistory";

const MaterialDetailDrawer = ({
  material,
  onClose,
  onUpdate,
  onDelete,
  ...
  return createPortal(
    <>
        ...
        >
          ...
          <div className="flex justify-between items-center px-3">
            <motion.button
              ...
              className="px-6 py-3 text-sm font-medium rounded-xl border border-blue-300 text-blue-600 hover:bg-blue-50 transition-colors"
            >
              View Transaction History
            </motion.button>
            <div className="py-6 flex gap-3 justify-end dark:bg-gray-900">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
      ...
      {showHistory && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center px-4 z-[100]">
          <div className="max-w-4xl w-full max-h-[85vh] top-0">
            <MaterialTransactionHistory
              materialId={material.master_material_id}
              materialName={
              ...
              onClose={() => {
                handleHistoryClose();
                // Optionally close the drawer too:
                // onClose();
              }}
            />
          </div>
