...
const InventoryTab = ({ inventory, loading, onMaterialSelect }) => {
  ...
  // Mobile Simplified Table (3 columns)
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-200 w-full text-xs dark:bg-gray-700">
            <tr>
              ...
              <th className="text-center py-3 px-3 capitalize">Quantity</th>
              <th className="text-center py-3 px-3 capitalize">Status</th>
            </tr>
          </thead>
          ...
          <tbody>
            {inventory.map((item, index) => (
              ...
              >
                <td className="py-3 px-3 text-left capitalize font-medium text-gray-900 dark:text-white">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <div className="font-medium truncate">
                        {item.master_materials?.name || "Unknown"}
                      </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-200 w-full text-xs dark:bg-gray-700">
            <tr>
              ...
              <th className="text-left py-3 px-3 capitalize">Total Quantity</th>
              <th className="text-left py-3 px-3 capitalize">Location</th>
              <th className="text-left py-3 px-3 capitalize">Batch No.</th>
              <th className="text-left py-3 px-3 capitalize">Last Received</th>
              <th className="text-left py-3 px-3 capitalize">Avg Unit Cost</th>
              <th className="text-center py-3 px-3 capitalize">Status</th>
            </tr>
          </thead>
