...
//   const handleTaskUpdate = async (newProgress) => {
//     setProject((prev) => ({ ...prev, progress: newProgress }));
//   };

//   // Initialize edited project when modal opens or project changes
//   useEffect(() => {
//     if (project) {
...
//     if (open) {
//       fetchTasks();
//       setShowTasks(false); // Reset tasks visibility when modal opens
...
//     // Use editedProject images when in edit mode, otherwise use project images
//     const source = isEditing ? editedProject : project;
//     return parseImages(source.images);
//   };

//   // Enhanced image upload with immediate preview
...
//   // Enhanced image removal using backend API
...
//     try {
//       // If it's a real uploaded image, delete from storage
...
//   // Helper function to update project images in database
...
//       if (!res.ok) {
//         console.error("Failed to update project images");
//       }
//     } catch (error) {
...
//     const splitTasksIntoColumns = (tasks) => {
//       const midPoint = Math.ceil(tasks.length / 2);
//       return {
//         leftColumn: tasks.slice(0, midPoint),
//         rightColumn: tasks.slice(midPoint),
//       };
//     };

//     const { leftColumn, rightColumn } = splitTasksIntoColumns(tasks);
...
//     <html>
//     <head>
//       <title>${capitalizeText(selectedProject.name)} - Project Report</title>
//       <style>
//         body {
...
//     <body>
//       <div class="header">
//         <div class="project-name">${capitalizeText(selectedProject.name)}</div>
//         <div>Project Report - Generated on ${new Date().toLocaleDateString()}</div>
//       </div>
...
//             <span class="value">${capitalizeText(selectedProject.status)}</span>
//           </div>
//           <div class="detail-item">
//             <span class="label">Priority:</span>
//             <span class="value">${capitalizeText(
//               selectedProject.priority
//             )}</span>
//           </div>
//           <div class="detail-item">
//             <span class="label">Phase:</span>
//             <span class="value">${capitalizeText(selectedProject.phase)}</span>
//           </div>
//           <div class="detail-item">
//             <span class="label">Progress:</span> ${selectedProject.progress}%
//           </div>
//         </div>
...
//             <span class="value">${capitalizeText(
//               selectedProject.project_manager || "Not specified"
//             )}</span>
//           </div>
//           <div class="detail-item">
...
//             <span class="value">${
//               selectedProject.contract_number || "Not specified"
//             }</span>
//           </div>
//           <div class="detail-item">
//             <span class="label">Start Date:</span> ${formatDate(
//               selectedProject.start_date
//             )}
//           </div>
//           <div class="detail-item">
//             <span class="label">End Date:</span> ${formatDate(
//               selectedProject.end_date
//             )}
//           </div>
//           <div class="detail-item">
//             <span class="label">Budget:</span> ${formatBudget(
...
//         <div class="value">${capitalizeText(selectedProject.description)}</div>
//       </div>
//       `
//           : ""
//       }
...
//             tasks.length === 0
//               ? `
//             <div class="no-tasks">No tasks available for this project</div>
//           `
//               : `
...
//                 }">
//                   <div class="task-name">${capitalizeText(task.task_name)}</div>
...
//   // Download Report as PDF or other formats
...
//                               {currentImages.length} image(s) in project folder
//                               - Click × to remove
//                             </p>
...
export default function ProjectDetailsModal({
  ...
  const generatePDFReport = () => {
    // Your existing PDF generation logic can remain here.
    // (Kept intentionally minimal — you already had it.)
    const reportContent = `<html><body><h1>${
      selectedProject?.name || ""
    }</h1></body></html>`;
    const printWindow = window.open("", "_blank");
    printWindow.document.write(reportContent);
  ...
  const handleDownloadReport = (format = "pdf") => {
    switch (format) {
      ...
      case "json": {
        ...
        const a = document.createElement("a");
        a.href = url;
        a.download = `${(selectedProject?.name || "project").replace(
          /\s+/g,
          "_"
        )}_report.json`;
        document.body.appendChild(a);
      ...
      <Transition show={showTasks} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 flex justify-end">
            ...
            >
              <Dialog.Panel className="w-full max-w-md h-full bg-white shadow-xl overflow-y-auto p-6">
