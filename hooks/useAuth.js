...
export function useAuth() {
  ...
  const checkManpowerExists = async (userId, token) => {
    try {
      console.log("🔍 Checking if user exists in manpower table...", userId);
      ...
      console.log("✅ Manpower check result:", data);
  ...
  const login = async (email, password) => {
    ...
    try {
      ...
      console.log("🟡 Checking manpower record...");
      ...
      console.log("✅ Manpower record found");
      ...
      console.log("🔴 Login process failed - Error details:", {
        code: error.code,
      ...
      console.log("🔴 Displaying user-friendly error:", errorMessage);
  ...
  const register = async (email, password, manpowerData) => {
    ...
    try {
      ...
      console.log("🚀 Creating manpower in Supabase:", supabaseManpowerData);
      ...
      console.log("✅ Manpower created in Supabase:", responseData);
      ...
      console.log("🔴 Registration process failed - Error details:", {
        code: error.code,
        message: error.message,
  ...
  const signInWithGoogle = async () => {
    ...
    try {
      ...
      // 3. Check if user exists in manpower table
      console.log("🟡 Checking manpower record for Google user...");
      const manpowerExists = await checkManpowerExists(firebaseUser.uid, token);

      if (!manpowerExists) {
        // If user doesn't exist in manpower, we need to create a record
        console.log("🟡 Google user not found in manpower, creating record...");
      ...
      if (error.code === "auth/popup-closed-by-user") {
        console.log("ℹ️ Google sign in popup was closed by user");
